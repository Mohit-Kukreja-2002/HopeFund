...
const Footer = () => {
    return (
        <footer className="bg-white">
            ...
            <div className="w-full max-w-screen-xl p-3 py-4 mx-auto lg:py-4">
                <div className="mb-2 md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <Link href={'/'}>
                            <Image priority className="w-[170px] h-auto m-0" alt='HopeFund-Logo' width={170} height={60}
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="font-medium text-gray-500">
                                <li className="mb-4">
                                    <a href="https://github.com/Mohit-Kukreja-2002/HopeFund-Rebuilt" target='_blank' className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/mohit-kukreja-347683229/" target='_blank' className="hover:underline">Linked in</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="font-medium text-gray-500">
                                <li className="mb-4 hover:underline">
                                    Call Us: +91-895-098-2811
                                </li>
                                <li className='hover:underline'>
                                    Address: IIIT Sonepat, 131001
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="py-2 sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center ">© 2024 HopeFund™. All Rights Reserved.
                    </span>
                    <div className="flex py-2 mt-4 sm:justify-center sm:mt-0">
                        <a href="https://www.facebook.com/mohit.kukreja.14203" target='_blank' className="text-gray-500 hover:text-gray-900">
                        ...
                        <a href="https://leetcode.com/Mohit_kukreja/" target='_blank' className="text-gray-500 hover:text-gray-900 ms-5 mt-[-4px]">
                            <svg className="w-4 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
                        ...
                        <a href="https://github.com/Mohit-Kukreja-2002/HopeFund-Rebuilt" target='_blank' className="text-gray-500 hover:text-gray-900 ms-5">
                        ...
                        <a href="https://www.codechef.com/users/mohitkukreja" target='_blank' className="text-gray-500 hover:text-gray-900 ms-5 mt-[-4px]">
                            <svg className="w-4 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <span className="sr-only">Codechef account</span>
                        </a>
                    </div>
                </div>
            </div>
